...
CREATE OR REPLACE INDEX IDX_EMPLOYEES_BU ON EMPLOYEES(BU_ID);
CREATE OR REPLACE INDEX IDX_EMPLOYEES_REGION ON EMPLOYEES(REGION_ID);
CREATE OR REPLACE INDEX IDX_EMPLOYEES_STATUS ON EMPLOYEES(EMPLOYMENT_STATUS);
CREATE OR REPLACE INDEX IDX_SKILLS_MATRIX_EMP ON SKILLS_MATRIX(EMPLOYEE_ID);
CREATE OR REPLACE INDEX IDX_CAPACITY_PERIOD ON WORKFORCE_CAPACITY(YEAR_MONTH);
CREATE OR REPLACE INDEX IDX_DIVERSITY_PERIOD ON DIVERSITY_METRICS(YEAR_MONTH);
