...
CREATE OR REPLACE TABLE SITES (
    ...
    COLOCATION_RATE FLOAT,  -- Computed: CURRENT_TENANTS / MAX_TENANTS
...
CREATE OR REPLACE TABLE EQUIPMENT (
    ...
    AGE_YEARS FLOAT,  -- Computed: years since installation
...
CREATE OR REPLACE TABLE ANTENNAS (
    ...
    -- Operator
    OPERATOR_ID VARCHAR(15) REFERENCES TDF_DATA_PLATFORM.CORE.OPERATORS(OPERATOR_ID),
