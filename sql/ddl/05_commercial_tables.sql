...
CREATE OR REPLACE INDEX IDX_FORECAST_TARGET ON DEMAND_FORECAST(TARGET_MONTH);
CREATE OR REPLACE INDEX IDX_FORECAST_BU ON DEMAND_FORECAST(BU_ID);
CREATE OR REPLACE INDEX IDX_PROJECTS_STATUS ON PROJECTS(STATUS);
CREATE OR REPLACE INDEX IDX_PROJECTS_OPERATOR ON PROJECTS(OPERATOR_ID);
CREATE OR REPLACE INDEX IDX_CONTRACTS_OPERATOR ON CONTRACTS(OPERATOR_ID);
CREATE OR REPLACE INDEX IDX_PIPELINE_STAGE ON CLIENT_PIPELINE(PIPELINE_STAGE);
